...
function _defineProperty(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _defineProperties(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}function _createClass(e,t,r){return t&&_defineProperties(e.prototype,t),r&&_defineProperties(e,r),e}import LineElement from"../elements/element.line";import{_boundSegment,_boundSegments}from"../helpers/helpers.segment";import{clipArea,unclipArea}from"../helpers/helpers.canvas";import{isArray,isFinite,isObject,valueOrDefault}from"../helpers/helpers.core";import{TAU,_normalizeAngle}from"../helpers/helpers.math";function getLineByIndex(e,t){var r=e.getDatasetMeta(t);return r&&e.isDatasetVisible(t)?r.dataset:null}function parseFillOption(e){var t=e.options,r=t.fill,n=valueOrDefault(r&&r.target,r);return void 0===n&&(n=!!t.backgroundColor),!1!==n&&null!==n&&(!0===n?"origin":n)}function decodeFill(e,t,r){var n=parseFillOption(e);if(isObject(n))return!isNaN(n.value)&&n;var i=parseFloat(n);return isFinite(i)&&Math.floor(i)===i?("-"!==n[0]&&"+"!==n[0]||(i=t+i),!(i===t||i<0||i>=r)&&i):["origin","start","end","stack","shape"].indexOf(n)>=0&&n}function computeLinearBoundary(e){var t,r=e.scale,n=void 0===r?{}:r,i=e.fill,a=null;return"start"===i?a=n.bottom:"end"===i?a=n.top:isObject(i)?a=n.getPixelForValue(i.value):n.getBasePixel&&(a=n.getBasePixel()),isFinite(a)?{x:(t=n.isHorizontal())?a:null,y:t?null:a}:null}var simpleArc=function(){function e(t){_classCallCheck(this,e),this.x=t.x,this.y=t.y,this.radius=t.radius}return _createClass(e,[{key:"pathSegment",value:function(e,t,r){var n=this.x,i=this.y,a=this.radius;return t=t||{start:0,end:TAU},e.arc(n,i,a,t.end,t.start,!0),!r.bounds}},{key:"interpolate",value:function(e){var t=this.x,r=this.y,n=this.radius,i=e.angle;return{x:t+Math.cos(i)*n,y:r+Math.sin(i)*n,angle:i}}}]),e}();function computeCircularBoundary(e){var t,r,n,i=e.scale,a=e.fill,o=i.options,l=i.getLabels().length,s=[],u=o.reverse?i.max:i.min,f=o.reverse?i.min:i.max;if(n="start"===a?u:"end"===a?f:isObject(a)?a.value:i.getBaseValue(),o.grid.circular)return r=i.getPointPositionForValue(0,u),new simpleArc({x:r.x,y:r.y,radius:i.getDistanceFromCenterForValue(n)});for(t=0;t<l;++t)s.push(i.getPointPositionForValue(t,n));return s}function computeBoundary(e){return(e.scale||{}).getPointPositionForValue?computeCircularBoundary(e):computeLinearBoundary(e)}function findSegmentEnd(e,t,r){for(;t>e;t--){var n=r[t];if(!isNaN(n.x)&&!isNaN(n.y))break}return t}function pointsFromSegments(e,t){var r=e||{},n=r.x,i=void 0===n?null:n,a=r.y,o=void 0===a?null:a,l=t.points,s=[];return t.segments.forEach((function(e){var t=e.start,r=e.end;r=findSegmentEnd(t,r,l);var n=l[t],a=l[r];null!==o?(s.push({x:n.x,y:o}),s.push({x:a.x,y:o})):null!==i&&(s.push({x:i,y:n.y}),s.push({x:i,y:a.y}))})),s}function buildStackLine(e){var t=e.chart,r=e.scale,n=e.index,i=e.line,a=[],o=i.segments,l=i.points,s=getLinesBelow(t,n);s.push(createBoundaryLine({x:null,y:r.bottom},i));for(var u=0;u<o.length;u++)for(var f=o[u],c=f.start;c<=f.end;c++)addPointsBelow(a,l[c],s);return new LineElement({points:a,options:{}})}var isLineAndNotInHideAnimation=function(e){return"line"===e.type&&!e.hidden};function getLinesBelow(e,t){for(var r=[],n=e.getSortedVisibleDatasetMetas(),i=0;i<n.length;i++){var a=n[i];if(a.index===t)break;isLineAndNotInHideAnimation(a)&&r.unshift(a.dataset)}return r}function addPointsBelow(e,t,r){for(var n=[],i=0;i<r.length;i++){var a=findPoint(r[i],t,"x"),o=a.first,l=a.last,s=a.point;if(!(!s||o&&l))if(o)n.unshift(s);else if(e.push(s),!l)break}e.push.apply(e,n)}function findPoint(e,t,r){var n=e.interpolate(t,r);if(!n)return{};for(var i=n[r],a=e.segments,o=e.points,l=!1,s=!1,u=0;u<a.length;u++){var f=a[u],c=o[f.start][r],d=o[f.end][r];if(i>=c&&i<=d){l=i===c,s=i===d;break}}return{first:l,last:s,point:n}}function getTarget(e){var t=e.chart,r=e.fill,n=e.line;if(isFinite(r))return getLineByIndex(t,r);if("stack"===r)return buildStackLine(e);if("shape"===r)return!0;var i=computeBoundary(e);return i instanceof simpleArc?i:createBoundaryLine(i,n)}function createBoundaryLine(e,t){var r=[],n=!1;return isArray(e)?(n=!0,r=e):r=pointsFromSegments(e,t),r.length?new LineElement({points:r,options:{tension:0},_loop:n,_fullLoop:n}):null}function resolveTarget(e,t,r){var n,i=e[t].fill,a=[t];if(!r)return i;for(;!1!==i&&-1===a.indexOf(i);){if(!isFinite(i))return i;if(!(n=e[i]))return!1;if(n.visible)return i;a.push(i),i=n.fill}return!1}function _clip(e,t,r){e.beginPath(),t.path(e),e.lineTo(t.last().x,r),e.lineTo(t.first().x,r),e.closePath(),e.clip()}function getBounds(e,t,r,n){if(!n){var i=t[e],a=r[e];return"angle"===e&&(i=_normalizeAngle(i),a=_normalizeAngle(a)),{property:e,start:i,end:a}}}function _getEdge(e,t,r,n){return e&&t?n(e[r],t[r]):e?e[r]:t?t[r]:0}function _segments(e,t,r){var n=e.segments,i=e.points,a=t.points,o=[],l=!0,s=!1,u=void 0;try{for(var f,c=n[Symbol.iterator]();!(l=(f=c.next()).done);l=!0){var d=f.value,p=d.start,v=d.end;v=findSegmentEnd(p,v,i);var g=getBounds(r,i[p],i[v],d.loop);if(t.segments){var h=_boundSegments(t,g),m=!0,y=!1,b=void 0;try{for(var x,w=h[Symbol.iterator]();!(m=(x=w.next()).done);m=!0){var _=x.value,P=getBounds(r,a[_.start],a[_.end],_.loop),B=_boundSegment(d,i,P),A=!0,D=!1,S=void 0;try{for(var L,F=B[Symbol.iterator]();!(A=(L=F.next()).done);A=!0){var T=L.value;o.push({source:T,target:_,start:_defineProperty({},r,_getEdge(g,P,"start",Math.max)),end:_defineProperty({},r,_getEdge(g,P,"end",Math.min))})}}catch(e){D=!0,S=e}finally{try{A||null==F.return||F.return()}finally{if(D)throw S}}}}catch(e){y=!0,b=e}finally{try{m||null==w.return||w.return()}finally{if(y)throw b}}}else o.push({source:d,target:g,start:i[p],end:i[v]})}}catch(e){s=!0,u=e}finally{try{l||null==c.return||c.return()}finally{if(s)throw u}}return o}function clipBounds(e,t,r){var n=t.chart.chartArea,i=n.top,a=n.bottom,o=r||{},l=o.property,s=o.start,u=o.end;"x"===l&&(e.beginPath(),e.rect(s,i,u-s,a-i),e.clip())}function interpolatedLineTo(e,t,r,n){var i=t.interpolate(r,n);i&&e.lineTo(i.x,i.y)}function _fill(e,t){var r=t.line,n=t.target,i=t.property,a=t.color,o=t.scale,l=_segments(r,n,i),s=!0,u=!1,f=void 0;try{for(var c,d=l[Symbol.iterator]();!(s=(c=d.next()).done);s=!0){var p=c.value,v=p.source,g=p.target,h=p.start,m=p.end,y=v.style,b=(y=void 0===y?{}:y).backgroundColor,x=void 0===b?a:b,w=!0!==n;e.save(),e.fillStyle=x,clipBounds(e,o,w&&getBounds(i,h,m)),e.beginPath();var _=!!r.pathSegment(e,v),P=void 0;if(w){_?e.closePath():interpolatedLineTo(e,n,m,i);var B=!!n.pathSegment(e,g,{move:_,reverse:!0});(P=_&&B)||interpolatedLineTo(e,n,h,i)}e.closePath(),e.fill(P?"evenodd":"nonzero"),e.restore()}}catch(e){u=!0,f=e}finally{try{s||null==d.return||d.return()}finally{if(u)throw f}}}function doFill(e,t){var r=t.line,n=t.target,i=t.above,a=t.below,o=t.area,l=t.scale,s=r._loop?"angle":t.axis;e.save(),"x"===s&&a!==i&&(_clip(e,n,o.top),_fill(e,{line:r,target:n,color:i,scale:l,property:s}),e.restore(),e.save(),_clip(e,n,o.bottom)),_fill(e,{line:r,target:n,color:a,scale:l,property:s}),e.restore()}function drawfill(e,t,r){var n=getTarget(t),i=t.line,a=t.scale,o=t.axis,l=i.options,s=l.fill,u=l.backgroundColor,f=s||{},c=f.above,d=void 0===c?u:c,p=f.below,v=void 0===p?u:p;n&&i.points.length&&(clipArea(e,r),doFill(e,{line:i,target:n,above:d,below:v,area:r,scale:a,axis:o}),unclipArea(e))}export default{id:"filler",afterDatasetsUpdate:function(e,t,r){var n,i,a,o,l=(e.data.datasets||[]).length,s=[];for(i=0;i<l;++i)o=null,(a=(n=e.getDatasetMeta(i)).dataset)&&a.options&&a instanceof LineElement&&(o={visible:e.isDatasetVisible(i),index:i,fill:decodeFill(a,i,l),chart:e,axis:n.controller.options.indexAxis,scale:n.vScale,line:a}),n.$filler=o,s.push(o);for(i=0;i<l;++i)(o=s[i])&&!1!==o.fill&&(o.fill=resolveTarget(s,i,r.propagate))},beforeDraw:function(e,t,r){for(var n="beforeDraw"===r.drawTime,i=e.getSortedVisibleDatasetMetas(),a=e.chartArea,o=i.length-1;o>=0;--o){var l=i[o].$filler;l&&(l.line.updateControlPoints(a,l.axis),n&&drawfill(e.ctx,l,a))}},beforeDatasetsDraw:function(e,t,r){if("beforeDatasetsDraw"===r.drawTime)for(var n=e.getSortedVisibleDatasetMetas(),i=n.length-1;i>=0;--i){var a=n[i].$filler;a&&drawfill(e.ctx,a,e.chartArea)}},beforeDatasetDraw:function(e,t,r){var n=t.meta.$filler;n&&!1!==n.fill&&"beforeDatasetDraw"===r.drawTime&&drawfill(e.ctx,n,e.chartArea)},defaults:{propagate:!0,drawTime:"beforeDatasetDraw"}};